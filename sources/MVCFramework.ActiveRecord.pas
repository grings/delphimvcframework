        ...
        begin
          ...
          begin
            ...
            MapDataSetFieldToRTTIField(
              lQry.FieldByName(fTableMap.fPrimaryKeyFieldName),
              fTableMap.fPrimaryKey, Self);
          end;
        end;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if ([foAutoGenerated, foRefresh] * lTableMap.fPrimaryKeyOptions) = [foAutoGenerated, foRefresh] then
                LogW(Format('ActiveRecord: entity [%s] PK field [%s] declares both foAutoGenerated and foRefresh; ' +
                  ...
                  [ClassName, lTableMap.fPrimaryKeyFieldName]));
